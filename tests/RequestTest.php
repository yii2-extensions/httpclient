...
class RequestTest extends TestCase
{
    ...
    public function testAddData(): void
    {
        ...
        $this->assertEquals([...$data1, ...$data2], $request->getData());
        $request->prepare();
        $request->addData($data3);
        $this->assertEquals([...$data1, ...$data2, ...$data3], $request->getData());
    }
...
EOL;
     ...
     */
    public function testGetFullUrl($baseUrl, mixed $url, $expectedFullUrl): void
    {
        $client = new Client();
